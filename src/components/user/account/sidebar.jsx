...
import ContactSupportIcon from 'assets/icons/contact_support';
import ExitIcon from 'assets/icons/exit';
import HomePlusIcon from 'assets/icons/home_plus';
import LocationOutlineIcon from 'assets/icons/location_outline';
...
function Sidebar({ deleteAuth }) {
	...
	return (
		<Grid item sx={{ width: '265px', display: { xs: 'none', md: 'block' } }}>
			...
			<List>
				...
				<NavLink to='/user/account/member'>
					{({ isActive }) => (
						<ListItem button className={classnames(classes.listItem, isActive && classes.activelistItem)}>
							<ListItemIcon sx={{ minWidth: '13px', marginRight: '13px' }}>
								<UserIcon style={{ color: isActive ? 'white' : '#25468A' }} />
							</ListItemIcon>
							<ListItemText sx={{ mb: 0 }}>
								<Typography variant='subtitle1' component='div' fontWeight='bold' color='inherit' lineHeight='22px'>
									Members
				...
				<NavLink to='/user/account/order'>
					{({ isActive }) => (
						<ListItem button className={classnames(classes.listItem, isActive && classes.activelistItem)}>
							<ListItemIcon sx={{ minWidth: '13px', marginRight: '13px' }}>
								<LocationOutlineIcon style={{ color: isActive ? 'white' : '#25468A' }} />
							</ListItemIcon>
							<ListItemText sx={{ mb: 0 }}>
								<Typography variant='subtitle1' component='div' fontWeight='bold' color='inherit' lineHeight='22px'>
									Orders
				...
				<NavLink to='/user/account/address'>
					{({ isActive }) => (
						<ListItem button className={classnames(classes.listItem, isActive && classes.activelistItem)}>
							<ListItemIcon sx={{ minWidth: '13px', marginRight: '13px' }}>
								<HomePlusIcon style={{ color: isActive ? 'white' : '#25468A' }} />
							</ListItemIcon>
							<ListItemText sx={{ mb: 0 }}>
								<Typography variant='subtitle1' component='div' fontWeight='bold' color='inherit' lineHeight='22px'>
									Addresses
				...
				<NavLink to='/user/support'>
					{({ isActive }) => (
						<ListItem button className={classnames(classes.listItem, isActive && classes.activelistItem)}>
							<ListItemIcon sx={{ minWidth: '13px', marginRight: '13px' }}>
								<ContactSupportIcon style={{ color: isActive ? 'white' : '#25468A' }} />
							</ListItemIcon>
							<ListItemText sx={{ mb: 0 }}>
								<Typography variant='subtitle1' component='div' fontWeight='bold' color='inherit' lineHeight='22px'>
									Support

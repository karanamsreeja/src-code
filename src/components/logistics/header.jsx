...
const DropDownItem = ({ title, list, ...props }) => {
	...
	return (
		<li {...props}>
			...
			>
				<MenuItem onClick={handleCloseNavMenu} sx={{ borderRadius: '4px', px: '8px', pt: '8px' }} component={Link} to=''>
					<SettingsIcon style={{ color: '#25468A', fontSize: '1.25rem' }} />
					<div style={{ marginLeft: '14px' }}>
						<Typography variant='subtitle2' lineHeight='16px' fontWeight={500}>
							Account Settings
						</Typography>
						<Typography variant='caption' color='#9E9E9E'>
							Consectetur adipis sit
						</Typography>
					</div>
				</MenuItem>
			</Menu>

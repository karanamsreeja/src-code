	...
	useEffect(() => {
		async function getData() {
			...
			if (res.status === 200) {
				...
				details.upload_on = OrderDateTimeFormatter(res.data.kit.timestamps.data_processing_ended);
				...
				<div className={classes.box}>
					<div style={{ padding: '15px 32px', background: '#25468A' }}>
						<Typography variant='caption' letterSpacing='1px' lineHeight='20px' fontWeight='bold' color='white' textTransform='uppercase'>
							Reports upload on {state.upload_on}
						</Typography>
					</div>
					<Stack direction='row' className={classes.stack}>
						...
						<div>
							<Button variant='contained' color='darkYellow' size='small' sx={{ borderRadius: '4px' }} onClick={handleViewReports}>

...
const FilterList = [
	...
	{ title: 'Pickup address', id: 'address' },
];
...
const PickupRequests = () => {
	...
	useEffect(() => {
		async function getData() {
			...
			const res = await axiosGet('/logistics/pickups', {}, setloading);
	...
	const handleAssignMember = async () => {
		...
		const res = await axiosPut('/logistics/pickups/assign', { order_id: selectedId, member_id: selectedMemberId }, setloading);

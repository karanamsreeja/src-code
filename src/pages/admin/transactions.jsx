...
import { formatState } from 'services/admin/transactions';

const FilterList = [
	{ title: 'Order ID', id: 'id' },
	{ title: 'Client Name', id: 'fullname' },
	{ title: 'Amount', id: 'amount' },
	{ title: 'Status', id: 'btnText' },
	{ title: 'Recieved on', id: 'date' },
];
...
const Transactions = () => {
	...
	useEffect(() => {
		async function getData() {
			const res = await axiosGet('/admin/payments', {}, setloading);
					...
					<Table sx={{ minWidth: 650, whiteSpace: 'nowrap' }} aria-label='simple table'>
						<TableHead>
							<TableRow>
								...
								<TableCell align='center'>Recieved on</TableCell>
						...
						<TableBody>
							{filterState?.map((e) => (
								<TableRow key={e.id}>
									...
									<TableCell scope='row' align='left'>
										<Typography variant='subtitle2' fontWeight='500' color='#212121'>
											{e.fullname}
										</Typography>
									</TableCell>
									<TableCell scope='row' align='left'>
										<Typography variant='subtitle1' fontWeight='bold' color='#212121'>
											{e.amount}
											<Typography variant='subtitle2' fontWeight='400' color='text.darkYellow'>
												{e.paymentMethod}
											</Typography>
										</Typography>
									</TableCell>
									...
									<TableCell align='left'>
										<Button variant='contained' color='darkYellow' size='small' sx={{ borderRadius: '4px' }}>
											<Typography variant='caption' fontWeight='bold'>
												Download Invoice
											</Typography>
										</Button>

...
import { formatState } from 'services/admin/kitStatus';

const FilterList = [
	{ title: 'Kit ID', id: 'id' },
	{ title: 'Client Name', id: 'fullname' },
	{ title: 'Order Recieved On', id: 'date' },
];
...
const Received = () => {
	...
	useEffect(() => {
		async function getData() {
			const res = await axiosGet('/admin/kit-delivery-status', {}, setloading);
					...
					<Table sx={{ minWidth: 650, whiteSpace: 'nowrap' }} aria-label='simple table'>
						<TableHead>
							<TableRow>
								...
								<TableCell align='center'>ORDER RECIEVED ON</TableCell>

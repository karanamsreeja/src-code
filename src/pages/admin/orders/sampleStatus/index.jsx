...
import { formatState } from 'services/admin/sampleStatus';

const FilterList = [
	{ title: 'Request ID', id: 'id' },
	{ title: 'Member Name', id: 'fullname' },
	{ title: 'Pickup Scheduled', id: 'date' },
];
...
const Received = () => {
	...
	useEffect(() => {
		async function getData() {
			const res = await axiosGet('/admin/sample-delivery-status', {}, setloading);
					...
					<Table sx={{ minWidth: 650, whiteSpace: 'nowrap' }} aria-label='simple table'>
						<TableHead>
							<TableRow>
								...
								<TableCell align='center'>Pickup Scheduled</TableCell>

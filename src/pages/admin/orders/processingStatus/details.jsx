	...
	useEffect(() => {
		async function getData() {
			...
			if (res.status === 200) {
				...
				details.recieved_on = OrderDateTimeFormatter(res.data.kit.timestamps.data_uploaded_on);
		...
		<>
			...
			<Container className='container-x'>
				<Stack direction='row' sx={{ mb: '30px' }}>
					<IconButton aria-label='delete' sx={{ transform: 'translateX(-16px)' }} component={Link} to='/admin/orders/processing-status'>
